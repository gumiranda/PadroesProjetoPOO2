...
import Strategy.Ataque.AtaqueVento;
 ...
 * @author Lara
 */
public class EscudoVento extends Escudo {
   
    
     public void inibirAtaque(Ataque ataque, Personagem p) {
        if (ataque instanceof AtaqueVento) {
  System.out.println("Ataque vento no personagem "+ataque.getPersonagemAtacado().getNome()+" inibido!");           } 
